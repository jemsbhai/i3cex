...
in [ADR-0010](./docs/adr/0010-bakeoff-evaluation-methodology.md). Proposed
...
methodology family is accepted and its manifest is frozen will the benchmark
harness be implemented.
